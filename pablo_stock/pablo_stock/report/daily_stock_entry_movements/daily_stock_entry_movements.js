...
function set_filter_based_on() {
    ...
    // Mostrar/ocultar filtros según el modo seleccionado
    ...
    if (based_on === "Date Range") {
        // Limpiar día si se elige rango de fechas
        frappe.query_report.set_filter_value({ day: null });

        // Si ya hay fechas en from/to, actualizar posting_date
        ...
        // Si se elige Day, usar el valor seleccionado (o hoy por defecto)
...
frappe.query_reports["Daily Stock Entry Movements"] = {
    "filters": [
        ...
        },
        {
            ...
            "fieldtype": "DateRange",
            "reqd": 1,
            "hidden": 1  // oculto, solo se usa internamente
        },
        {
            "fieldname": "item_code",
            "label": __("Item"),
